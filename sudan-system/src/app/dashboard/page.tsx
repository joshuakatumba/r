    ...
    <>
      ...
      <div className="dashboard-grid">
        <div className="card stat-card">
          ...
          <Link href="/create" className="btn btn-primary mt-4 btn-block">New Transfer</Link>
        </div>
        
        <div className="card stat-card">
          <h3>Transfers Received</h3>
          <div className="value text-success">{receivedCount}</div>
          <Link href="/claim" className="btn btn-success mt-4 btn-block">Process Claim</Link>
        </div>
