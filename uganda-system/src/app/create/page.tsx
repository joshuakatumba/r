            ...
            <div className="flex flex-col md:flex-row">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="form-group">
                      ...
                      <input className="form-input" id="senderContact" name="senderContact" type="tel" placeholder="+249..." required />
                    </div>
                    <div className="form-group">
                  ...
                  <div className="form-group">
                    <label className="form-label" htmlFor="amount">Transfer Amount (UGX)</label>
                    <div style={{ position: 'relative' }}>
                      <span style={{ position: 'absolute', left: '1rem', top: '50%', transform: 'translateY(-50%)', fontWeight: 600, color: 'var(--text-secondary)' }}>UGX</span>
                      <input
                        ...
                        min="1"
                        step="0.01"
                        style={{ paddingLeft: '3.5rem', fontSize: '1.5rem', fontWeight: 700, color: 'var(--accent-primary)' }}
                        placeholder="0.00"
                        required
                      />
                    </div>
              ...
              <div style={{ width: '100%', maxWidth: '320px', padding: '3.5rem', background: 'rgba(0,0,0,0.02)' }}>
                ...
                <div style={{ marginTop: '4rem' }}>
                  <Link href="/history" className="btn btn-secondary btn-block" style={{ fontSize: '0.85rem', gap: '8px' }}>
              ...
              <table style={{ width: '100%', fontSize: '0.85rem' }}>
                <tbody>
                  <tr>
                    ...
                    <td style={{ padding: '0.25rem 0', textAlign: 'right', fontWeight: 700 }}>UGX {result.rawData?.amount.toLocaleString()}</td>
                  </tr>
                  <tr>
